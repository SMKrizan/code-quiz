// CODE QUIZ: 10 true and false questions and their answers
var questions = [
    {
    ...
    {
        question: 'A callback function is a function that is passed as an argument to another function.', 
        options: ['T', 'F'],
        answer: 'T',
        ifWrong: "INCORRECT: the statement above is true."
    },
    {
        question: 'JavaScript data types include numbers, strings, objects, boolean operators, functions, and arrays.', 
        options: ['T', 'F'],
        answer: 'T',
        ifWrong: "INCORRECT: the statement above is true."
    },
